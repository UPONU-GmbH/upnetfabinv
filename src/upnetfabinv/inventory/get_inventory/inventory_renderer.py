...
from upnetfabinv.shared_utils import SharedUtils
from upnetfabinv.utils import merge, get, get_all_items
...
FAB_INVENTORY_CLASSES = [Inventory]

FAB_INVENTORY_HOST_VARS_CLASSES = [AnsibleFacts]
