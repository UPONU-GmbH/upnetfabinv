...
class L3leafMixin:
    ...
    def l3leaf_os10(self: AvailabilityZone):
        ...
        l3leafs_os10 = get_all_items(
            get_all_items(self.shared_utils.l3leafs, "custom_fields.avd_node_type", "l3leaf_os10"),
            "site.name", self._avialability_zone)

        node_groups = []

        for node_group in self._get_node_groups(l3leafs_os10):

            node_groups.append(self._get_l3leaf_os10_node_group(node_group, l3leafs_os10))
    ...
    def l3leaf(self: AvailabilityZone):
        ...
        l3leafs = get_all_items(
            get_all_items(self.shared_utils.l3leafs, "custom_fields.avd_node_type", "l3leaf"),
            "site.name", self._avialability_zone)
    ...
    def _get_l3leaf_os10_node_group(self: AvailabilityZone, node_group: str, all_nodes: list[dict]):

        group_nodes = get_all_items(all_nodes, "custom_fields.avd_switch_group_name", node_group)
    ...
    def _get_l3leaf_node_group(self: AvailabilityZone, node_group: str, all_nodes: list[dict]):
            ...
            for link_peer in get(interface, "link_peers"):
                ...
                if peer_device := get(link_peer, "device"):
                    ...
                    if get(peer, "custom_fields.avd_node_type") == "spine":
                        ...
                        uplinks["uplink_switch_interfaces"].append(get(link_peer, "name"))
