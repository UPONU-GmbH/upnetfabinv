...
GET_ALL_ITEMS_DATA = [
    ...
    {  # required - missing
        ...
        "expected_length": 0,
        "expected_exception": pytest.raises(UPONUDCFabInventoryMissingVariableError, match="key5.missing_required"),
    },
]
...
class TestUtilsGetAllItems:
    ...
    def test_get_all_items(self, DATA):
        with DATA["expected_exception"]:
            res = get_all_items(DATA["list"], DATA["key"], DATA["value"], DATA["required"])
